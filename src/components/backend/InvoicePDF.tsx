...
export const InvoicePDF = ({ student, payments, logoBase64 }: InvoiceProps) => {
  ...
  const invoiceNo = `MPEC-${student.enrollment_date ? format(new Date(student.enrollment_date), 'yyyyMM') : format(new Date(), 'yyyyMM')}-${student.id.slice(-4).toUpperCase()}`
        ...
        <View style={styles.content}>
          ...
          <View style={styles.header}>
            <View style={styles.logoBlock}>
              ...
              <Text style={styles.companyName}>MEERA PRAKASH EDUCATION CENTER</Text>
              <Text style={styles.companyDetail}>Sahganj, Professor Colony, Near SBI ATM</Text>
              <Text style={styles.companyDetail}>Patna – 800006, Bihar</Text>
              <Text style={styles.companyDetail}>Ph: 87091 65052, 98014 45739</Text>
              <Text style={styles.companyDetail}>Email: meeraprakasheducation@gmail.com</Text>
            </View>
          ...
          <View style={styles.footer}>
            <View>
              ...
              <Text style={styles.footerLeft}>For queries: 87091 65052 | meeraprakasheducation@gmail.com</Text>
              <Text style={[styles.footerLeft, { marginTop: 4, color: ACCENT }]}>Thank you for choosing Meera Prakash Education Center!</Text>
            </View>
